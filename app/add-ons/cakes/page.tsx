		...
		<div className="min-h-screen bg-gray-50">
			...
			<section className="bg-gradient-to-r from-[var(--primary-lighter)] to-[var(--primary-light)] py-16">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					<h1 className="font-great-vibes text-5xl md:text-6xl text-white mb-6">
						Delicious Cakes & Cupcakes
					</h1>
					<p className="text-xl text-white max-w-3xl mx-auto">
						Sweet treats to complement your beautiful flower arrangements. Our
						freshly baked cupcakes are the perfect addition to any celebration.
					</p>
				</div>
			</section>
				...
				<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-12">
						...
						<p className="text-lg text-gray-600 max-w-3xl mx-auto">
							Our cupcakes are baked fresh daily using premium ingredients. Each
							one is carefully crafted to ensure the perfect taste and
							presentation.
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						<div className="text-center">
							...
							<p className="text-gray-600">
								We use only the finest ingredients to ensure every cupcake is
						...
						<div className="text-center">
							...
							<p className="text-gray-600">
								Each cupcake is artistically decorated to complement your flower
						...
						<div className="text-center">
							...
							<p className="text-gray-600">
								Carefully packaged to maintain freshness and arrive in perfect
								condition with your flowers.
							</p>
						</div>
					</div>
				</div>
			...
			<section className="bg-[var(--primary)] py-16">
				<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="text-xl text-white mb-8">
						Add our delicious cupcakes to your flower order for a complete gift
						...
						>
							<Link
								href={`https://wa.me/254715744816?text=${encodeURIComponent(
									"Hi! I would like to add cupcakes to my flower order."
								)}`}
								target="_blank"
							>
								Custom Order
